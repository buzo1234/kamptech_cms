  ...
  return (
    <div className="App h-screen relative">
      ...
      <div className={
              ...
              (navbarOpen ? "inset-y-0 left-0 mt-16 flex w-full bg-black bg-opacity-20 absolute lg:hidden xl:hidden" : "hidden")
            }
            onClick={() => setNavbarOpen(!navbarOpen)}
            >
            ...
            <ul className="flex flex-col list-none lg:ml-auto px-3 w-full  ">
              <li className="nav-item  hover:bg-gray-300/20">
                <a
                  ...
                  href="/"
                >
                  <GridViewOutlinedIcon/><span className="ml-2">Dashboard</span>
                </a>
              </li>
              <li className="nav-item hover:bg-gray-300/20">
                <a
                  ...
                  href="/products"
                >
                  <LocalMallOutlinedIcon/><span className="ml-2">Products</span>
                </a>
              </li>
              <li className="nav-item hover:bg-gray-300/20">
                <a
                  ...
                  href="/category"
                >
                  <FormatListBulletedOutlinedIcon /><span className="ml-2">Category</span>
                </a>
              </li>
              <li className="nav-item hover:bg-gray-300/20">
                <a
                  ...
                  href="/orders"
                >
                  <ExploreOutlinedIcon /><span className="ml-2">Orders</span>
                </a>
              </li>
              <li className="nav-item hover:bg-gray-300/20">
                <a
                  ...
                  href="/coupons"
                >
                  <RedeemOutlinedIcon/><span className="ml-2">Coupons</span>
                </a>
              </li>
            </ul>
          </div>
