...
const CategoryScreen = () => {
  return (
    <>
      <div>
        <p className="font-bold mt-4 text-2xl">Manage Categories</p>
      </div>
      <div class="p-4">
        <form class="py-3 md:pb-0 grid gap-4 lg:gap-6 xl:gap-6  xl:flex">
            ...
            <div class=" lg:flex md:flex flex-grow-0">
              <div class="flex">
                <div class="lg:flex-1 md:flex-1 mr-3 sm:flex-none">
                  <button
                    class="border flex justify-center items-center border-gray-300 hover:border-green-400 hover:text-green-400  dark:text-gray-300 cursor-pointer h-10 w-20 rounded-md focus:outline-none"
                ...
                <div class="lg:flex-1 md:flex-1 mr-3  sm:flex-none">
                  <button
                    class="border flex justify-center items-center h-10 w-20 hover:text-yellow-400  border-gray-300 dark:text-gray-300 cursor-pointer  py-2 hover:border-yellow-400 rounded-md focus:outline-none"
          ...
          <div class="lg:flex  md:flex xl:justify-end xl:w-1/2  md:w-full md:justify-start flex-grow-0">
            ...
            <div class="w-full md:w-48 lg:w-48 xl:w-48">
              <button
