    ...
    <>
      ...
      {addCat && (
        <>
          ...
          <div className="absolute right-0 overflow-auto   z-[200] top-0 6 w-full lg:w-2/3 xl:w-2/3 bg-white transform -translate-x-0 transition duration-300 ease-in-out " style={{minHeight: "-webkit-fill-available"}} >
